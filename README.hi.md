...
- **`0.1.0-rc.6`/`0.1.0-rc.8` पर सत्र ईवेंट।** हार्नेस अभी `sync/*` प्रकार पंजीकृत नहीं करता, इसलिए सत्र-लॉग जोड़ छोड़ दिए जाते हैं (सत्र लोड होते रहते हैं); प्लगइन उन्हें स्वतः सक्षम करता है जब कोई होस्ट प्रकार पंजीकृत करता है या `Session.append` पर `ignorable` लिफ़ाफ़ा उजागर करता है।
...
pnpm run typecheck && pnpm run typecheck:ci        # प्रकाशित rc.8 peers के विरुद्ध tsc --checkJs
