...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.1` (GitHub टैग, 2026-09-22 को सत्यापित: पिन किए गए `0.1.7-alpha.1` peers के विरुद्ध पूर्ण गेट श्रृंखला)। npm निर्भरता-लाइन `0.1.7-alpha.1`, peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0`। (2026-09-22 को अनुकूलित): टकराव फ़ोर्क सूचना प्लगइन का अपना producer-owned source kind रखती है - हार्नेस ने साझा `plugin` kind सेवानिवृत्त कर दिया है और पुनः-पठन पर उसे अस्वीकार करता है। |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
- **`0.1.0-rc.6`/`0.1.0-rc.8`/`0.1.1-rc.2`/`0.1.2-alpha.2`/`0.1.2-alpha.3`/`0.1.2-rc.1`/`0.1.7-alpha.1` पर सत्र ईवेंट।** हार्नेस अभी `sync/*` प्रकार पंजीकृत नहीं करता, इसलिए सत्र-लॉग जोड़ छोड़ दिए जाते हैं (सत्र लोड होते रहते हैं); प्लगइन उन्हें स्वतः सक्षम करता है जब कोई होस्ट प्रकार पंजीकृत करता है या `Session.append` पर `ignorable` लिफ़ाफ़ा उजागर करता है।
...
pnpm run typecheck && pnpm run typecheck:ci        # प्रकाशित 0.1.7-alpha.1 peers के विरुद्ध tsc --checkJs
