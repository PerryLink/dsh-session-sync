...
export function backendUnsupported(backend) {
  return new SyncError(
    ...
    `sync backend ${JSON.stringify(backend)} is not implemented (only "git" is; encrypted backends are reserved, keys never enter the repo)`,
    { backend },
  )
}
