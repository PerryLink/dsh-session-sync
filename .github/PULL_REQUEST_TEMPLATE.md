...
- [ ] All gates pass locally (`pnpm run typecheck && pnpm run typecheck:ci && pnpm test && pnpm run verify:self-contained && pnpm run verify:artifacts && pnpm run check:readmes && pnpm pack`)
